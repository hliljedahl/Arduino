...
#include "ESP8266WiFi.h" //Wifi library fro Arduino MKR1000 and WiFi shield


int lControl =  D5; //Digital pin that LED is connected to on the MKR1000
char ssid[] = "Tonic";      // your network SSID (name)
char pass[] = "fetthemligt";   // your network password
